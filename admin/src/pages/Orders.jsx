...
function Orders() {
  ...
  return (
    <div className='w-full min-h-[100vh] text-white  bg-gradient-to-l from-[#141414] to-[#0c2025]'>
      <Nav/>
      <div className='w-[100%] h-[100%] flex items-center justify-center lg:justify-start'>
          <Sidebar />
          <div className='lg:w-[85%] md:w-[70%] h-[100%] lg:ml-[310px] md:ml-[250px] mt-[70px] gap-[30px] overflow-x-hidden py-[50px] ml-[100px] flex flex-col'>
            <div className='w-[500px] h-[50px] text-[28px] md:text-[40px] mb-[20px] text-white'>
              All Orders List
            </div>
            {
              orders.map((order, index)=>(
                <div key={index} className='w-[90%] h-[40%] flex items-start justify-between lg:items-center flex-col lg:flex-row gap-[20px] bg-slate-600 p-[10px] md:px-[20px] rounded-xl  '>
