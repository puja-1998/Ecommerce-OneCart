                            ...
                            <div className='flex  items-start justify-center flex-col gap-[5px]'>
                                ...
                                <div className='flex items-center'>
                                    <p className='md:text-[18px] text-[12px] text-[#aaf4e7]'>
                                        Date: <span className='md:text-[16px] text-[11px] pl-[10px] text-[#e4fbff]'>
                                ...
                                <div className='absolute md:right-[5%] md:top-[40%] right-[1%] top-[70%]'>
                                    <button onClick={loadOrderData} className='md:px-[15px] px-[5px] md:py-[7px] py-[3px] rounded-md bg-[#101919] text-[#f3f9fc] md:text-[16px] text-[12px] cursor-pointer active:bg-slate-500'>
                                        Track Order
                                    </button>
                                </div>
                            </div>
